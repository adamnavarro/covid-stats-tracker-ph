 ...
 * @type INPUT_OBJECT
 */
export type CountryFilter = { country: string | null };
 ...
 * @type OBJECT
 */
type t_CountryStats = FieldsType<
  {
    __typename: t_String<"CountryStats">;
    country: t_String | null;
    cases: t_Int | null;
    todayCases: t_Int | null;
    deaths: t_Int | null;
    todayDeaths: t_Int | null;
    recovered: t_Int | null;
    active: t_Int | null;
    critical: t_Int | null;
    casesPerOneMillion: t_Int | null;
    deathsPerOneMillion: t_Int | null;
    countryCode: t_String | null;
    confirmed: t_Int | null;
  },
 ...
 * @type OBJECT
 */
export type CountryStats = TypeData<t_CountryStats>;
